...
export class SceneManager {
    ...
    setupShowroom() {
        ...
        // Visual Platform (Top surface is at Y=0.2)
    ...
    async loadCarModel(modelPath, onProgress) {
        return new Promise((resolve, reject) => {
            ...
            loader.load(modelPath, (gltf) => {
                ...
                // 3. Re-calculate box after scaling
                ...
                // 5. Fix Height - The Calculation:
                // box.min.y is the absolute lowest point (bottom of tires).
                // We want the tires to touch Y=0.2 (top of platform).
                // Formula: -lowestPoint + platformHeight
                this.car.position.y = -box.min.y + 0.2;
    ...
    createPlaceholderCar() {
        ...
        wheelPositions.forEach(pos => {
            ...
            const tire = new THREE.Mesh(new THREE.CylinderGeometry(wheelRadius, wheelRadius, 0.3, 32), tireMat);
            tire.rotation.z = Math.PI / 2;
            tire.castShadow = true;
            
            // IMPORTANT: Tire mesh center is 0. 
            // We move tire mesh up by radius so its bottom is at 0.
            tire.position.y = wheelRadius; 
            
            grp.add(tire);
            grp.position.set(pos.x, 0, pos.z); // Group sits at 0 height
            this.wheels.push(grp);
            this.car.add(grp);
        });
        
        // Save ref for color changing
